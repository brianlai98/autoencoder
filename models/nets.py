...
def generator_net(images, scope, reuse=None, training=True):
    """Mask network.
    Args:
    ...
    mask_channels = 3 # probability of 1 and zero
    # x = tf.concat((images, flow), 3)  #[B, H, W, 5]
    x = images
    cnum = 32
